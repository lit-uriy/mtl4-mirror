...
int test_main(int, char**)
{
    ...
    typedef vector::parameters<tag::col_major, vector::fixed::dimension<2>, true> col_para;
    typedef vector::parameters<tag::row_major, vector::fixed::dimension<2>, true> row_para;
    float va[2]= {3., 4.};
