...
namespace matrix {
    ...
    inline max_abs_pos(const Matrix& A, typename Collection<Matrix>::size_type& r,
...
namespace vector {
    ...
    inline max_abs_pos(const Vector& v, typename Collection<Vector>::size_type& i)
    {
	using std::abs;
