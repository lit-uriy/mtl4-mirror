...
# include <boost/fusion/counting_iterator.hpp>
...
namespace impl
{
  ...
  template <class S>
  struct begin<S, fusion_tag>
  {
      typedef fusion::counting_iterator<
          typename fusion::result_of::begin<S>::type
      > result_type;
      
      result_type operator()(S& s) const
      {
          return result_type(fusion::begin(s));
      }
  };
}
...
{
  using mpl::_;
  struct begin : boost::detail::function1<impl::begin<_,impl::tag<_> > > {};
}
