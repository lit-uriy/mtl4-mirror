...
// ===========
    ...
    , detail::all_rows_range_generator<mtl::compressed2D<Elt, Parameters>, complexity_classes::linear_cached>
    , range_generator<tag::unsupported, mtl::compressed2D<Elt, Parameters> >
        >::type {};


    template <class Elt, class Parameters>
    struct range_generator<glas::tag::nz,
         detail::sub_matrix_cursor<mtl::compressed2D<Elt, Parameters>, glas::tag::row, 2> >
    {
  typedef detail::sub_matrix_cursor<mtl::compressed2D<Elt, Parameters>, glas::tag::row, 2> cursor_type;
  ...
  type end(cursor_type const& cursor) const
  {
    ...
    , detail::all_cols_range_generator<mtl::compressed2D<Elt, Parameters>, complexity_classes::linear_cached>
    , range_generator<tag::unsupported, mtl::compressed2D<Elt, Parameters> >
        >::type {};
    ...
    template <class Elt, class Parameters>
    struct range_generator<glas::tag::nz,
         detail::sub_matrix_cursor<mtl::compressed2D<Elt, Parameters>, glas::tag::col, 2> >
    {
  typedef detail::sub_matrix_cursor<mtl::compressed2D<Elt, Parameters>, glas::tag::col, 2> cursor_type;
  typedef complexity_classes::linear_cached         complexity;
  typedef compressed_minor_cursor<Elt, Parameters>  type;
  static int const                                  level = 1;
