...
struct vec_vec_minus_asgn_expr 
    : public vec_vec_aop_expr< E1, E2, sfunctor::minus_assign<typename E1::value_type, typename E2::value_type> >
{
    typedef vec_vec_aop_expr< E1, E2, sfunctor::minus_assign<typename E1::value_type, typename E2::value_type> > base;
