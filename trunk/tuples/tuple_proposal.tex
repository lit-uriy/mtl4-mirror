...
would be a most useful, allowing, e.g., truly generic forwarding functions
that could accept any number of parameters. 
...
be constructed (see section~\ref{about_valid_element_types}).
...
elementwise assignable. For example:
%
\begin{alltt}
tuple<char, int, const char(&)[3]> t1('a', 1, "Hi");
...
elementwise inequality comparisons.
