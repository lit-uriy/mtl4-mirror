...
template <typename T>
struct gradient 
  : boost::mpl::if_<is_scalar<T>, dense_vector<T>, tag::unknown>
{};	

template <typename Value, typename Para>
struct gradient<dense_vector<Value, Para> >
  : linear_operator<dense_vector<Value, Para>, dense_vector<Value, Para> >
{};
